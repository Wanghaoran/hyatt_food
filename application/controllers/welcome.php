...
class Welcome extends CI_Controller {
    ...
    public function vote(){
        ...
        if($this -> hotel_model -> addnum($cid)){
            ...
            $url = 'http://service.weibo.com/share/share.php?url=http%3A%2F%2apps.weibo.com%2F2259266354%2FQp1a6Ji&appkey=392409152&language=zh_cn&title=' . $con . '&source=&sourceUrl=&ralateUid=2259266354&message=&uids=&pic=&searchPic=false&content=';
            $result['url'] = $url;
